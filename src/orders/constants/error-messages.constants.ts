export const error_messages = {
    ...
    token_not_supported: (address: string) => `Token ${address} is not supported`,
    ...
    order_invalid_status_for_cancel: "Order can only be cancelled when status is pending or partial",
} as const;
